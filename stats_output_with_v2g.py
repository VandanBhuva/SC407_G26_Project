...
class Experiment():
    ...
    def __init__(self, experiment_params={}):
        ...
        self.Q = np.load('average_runs/test_run_Q.npy')
...
#             self.average_list.append(average)
        ...
        #print(self.Q)
         #Save statistics
        np.save(id_run + '_reward_list1.npy', self.reward_list)
        np.save(id_run + '_average_list1.npy', self.average_list)
        np.save(id_run + '_Q1.npy', self.Q)
        np.save(id_run + '_PAR_list1.npy', self.PAR_list)
        np.save(id_run + '_max_list1.npy', self.max_load_list)
        np.save(id_run + '_Q_change_list1.npy', self.Q_change_list)
        ...
        par_with_v2g = str(np.array(self.PAR_list).mean())
        with open('par_with_v2g.txt', 'w') as f:
            f.write(par_with_v2g)
        # print(f'In sim file : {par_with_v2g}')
